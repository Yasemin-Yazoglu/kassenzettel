...
interface ExpenseFormProps {
    onSubmit: (item: DraftExpense) => void;
}
...
export default function ExpenseForm({ onSubmit }: ExpenseFormProps) {
    ...
    return (
        <form
            className="bg-white/20 p-1.5 rounded-2xl text-white/90 font-mono flex flex-col mx-4 lg:mx-0 sm:flex-row justify-between items-center gap-1.5"
